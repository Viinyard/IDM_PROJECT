...
public class VideoGenGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class VideoDescriptionElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cDurationDOUBLEParserRuleCall_3_1_1_0 = (RuleCall)cDurationAssignment_3_1_1.eContents().get(0);
		private final Group cGroup_3_2 = (Group)cGroup_3.eContents().get(2);
		...
		private final RuleCall cProbabilityDOUBLEParserRuleCall_3_2_1_0 = (RuleCall)cProbabilityAssignment_3_2_1.eContents().get(0);
		...
		//VideoDescription:
		//	'videoseq' videoid=ID? location=STRING (LEFT_BRACKET ('duration' duration=DOUBLE)? ('probability' probability=DOUBLE)?
		...
		//(LEFT_BRACKET ('duration' duration=DOUBLE)? ('probability' probability=DOUBLE)? ('description' description=STRING)?
		//('filter' filter=Filter)? ('text' text=VideoText)? // incrust a text into a video
		//RIGHT_BRACKET)?
		public Group getGroup_3() { return cGroup_3; }
		...
		//DOUBLE
		public RuleCall getDurationDOUBLEParserRuleCall_3_1_1_0() { return cDurationDOUBLEParserRuleCall_3_1_1_0; }
		...
		//DOUBLE
		public RuleCall getProbabilityDOUBLEParserRuleCall_3_2_1_0() { return cProbabilityDOUBLEParserRuleCall_3_2_1_0; }
	...
	public class OptionalIntElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "fr.istic.VideoGen.OptionalInt");
	...
	public class DOUBLEElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "fr.istic.VideoGen.DOUBLE");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class LONGElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "fr.istic.VideoGen.LONG");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final RuleCall cINTTerminalRuleCall_0 = (RuleCall)cGroup.eContents().get(0);
