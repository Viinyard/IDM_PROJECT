...
public class VideoGenPackageImpl extends EPackageImpl implements VideoGenPackage
{
   ...
   * @see fr.istic.videoGen.VideoGenPackage#eNS_URI
   * @see #init()
   * @generated
   */
  ...
  public void initializePackageContents()
  {
    ...
    initEAttribute(getVideoDescription_Duration(), ecorePackage.getEDoubleObject(), "duration", null, 0, 1, VideoDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getVideoDescription_Probability(), ecorePackage.getEDoubleObject(), "probability", null, 0, 1, VideoDescription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
